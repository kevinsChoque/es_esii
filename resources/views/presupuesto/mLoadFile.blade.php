                    ...
                    <div class="col-lg-12 contTabs">
                        <div class="tab-content" id="custom-tabs-one-tabContent">
                            ...
                            <div class="tab-pane fade active show" id="listar-files" role="tabpanel" aria-labelledby="listar-files-tab">
                                <div class="table-responsive contRegFilesPres">
...
<script>
    ...
    {
        $('#idRegistro').val($(element).attr('data-idPre'));
        construirTablaFiles();
        listarFilePres($('#idRegistro').val());
    ...
    {
        $('.contRegFilesPres>div').remove();
        $('.contRegFilesPres').html(tablaDeRegistrosArchivos);
    }
    function listarFilePres(id)
    {
        jQuery.ajax(
        { 
            url: "{{url('archivo/listarPres')}}",
            data: {idPre:id},
            method: 'get',
