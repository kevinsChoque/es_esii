                    ...
                    <div class="col-lg-12 contTabs">
                        <div class="tab-content" id="custom-tabs-one-tabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <form method="post" enctype="multipart/form-data" class="dropzone dz-clickable h-100 text-center py-0" id="dSubirArchivo" style="height: 250px !important;">
                                            ...
                                            <input type="hidden" id="solnroFileSoli" name="solnroFileSoli">
                            ...
                            <div class="tab-pane fade active show" id="listar-files" role="tabpanel" aria-labelledby="listar-files-tab">
                                <div class="table-responsive contRegFilesSoli">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <form method="post" enctype="multipart/form-data" class="dropzone dz-clickable h-100 text-center py-0" id="edSubirArchivo" style="height: 250px !important;">
                                    ...
                                    <input type="hidden" id="esolnroFileSoli" name="esolnroFileSoli">
...
<script>
    ...
    function loadFile(element)
    {
        ...
        $('#solnroFileSoli').val($(element).attr('data-solnro'));
        construirTablaFiles();
    ...
    function editarArchivo(idArchivo)
    {
        ...
        { 
            ...
            success: function(r){
                ...
                $('#esolnroFileSoli').val(r.data.idSolicitud);
    ...
    {
        $('.contRegFilesSoli>div').remove();
        $('.contRegFilesSoli').html(tablaDeRegistrosArchivos);
    }
    function listarFileSoli(id)
    {
        jQuery.ajax(
        { 
            url: "{{url('archivo/listarSoli')}}",
            data: {idSolicitud:id},
            method: 'get',
